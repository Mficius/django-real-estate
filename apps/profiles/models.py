...
class Profile(TimeStampedUUIDModel):
    ...
    country = CountryField(verbose_name=_("Country"), default="GA", blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Libreville", blank=False, null=False)
    is_buyer = models.BooleanField(verbose_name=("Buyer"), default=False, help_text=_("Are you looking to Buy a Property?"))
