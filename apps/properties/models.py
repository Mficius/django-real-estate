...
class Property(TimeStampedUUIDModel):
    ...
    user = models.ForeignKey(User, verbose_name=_("Agent,Seller or Buyer"), related_name="agent", 
    ...
    country = CountryField(verbose_name=_("Country"), default="GA", blank_label="(select country)")
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Libreville", blank=True)
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=100, default="140")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="IAI Libreville")
    ...
    tax = models.DecimalField(verbose_name=_("Property Tax"), max_digits=6, 
                decimal_places=2, default=0.15, help_text=_("15% property tax charged"))
    ...
    property_type = models.CharField(verbose_name=("Property Type"), max_length=50, choices=PropertyType.choices, default=PropertyType.OTHER)
    ...
    published_status = models.BooleanField(
        verbose_name=_("Publised Status"), default=False
    )
    views = models.IntegerField(verbose_name=_("Total Views"), default=0)

    objects = models.Manager()
    publised = PropertyPublishedManager()
    ...
    def save(self, *args, **kwargs):
        ...
        self.ref_code = "".json(random.choices(string.ascii_uppercase + string.digits, k=10))
